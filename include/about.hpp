...
template <typename T> constexpr auto get_name(const T& value) { return ClassMetaInfo<T>::name; }

template <typename T> constexpr const char* nameof = ClassMetaInfo<T>::name;
